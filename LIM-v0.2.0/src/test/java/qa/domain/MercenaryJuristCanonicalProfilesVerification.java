...
public final class MercenaryJuristCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(MercenaryCanonicalProfiles.all(), Profession.MERCENARY, "MercenaryCanonicalProfiles"); check(JuristCanonicalProfiles.all(), Profession.JURIST, "JuristCanonicalProfiles"); }
