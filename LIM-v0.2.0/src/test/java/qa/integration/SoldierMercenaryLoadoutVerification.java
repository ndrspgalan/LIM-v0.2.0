...
public final class SoldierMercenaryLoadoutVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(SoldierCanonicalProfiles.all(), Profession.SOLDIER, (s,c)->SoldierStartingEquipmentCatalog.equipment(s,c)); audit(MercenaryCanonicalProfiles.all(), Profession.MERCENARY, (s,c)->MercenaryStartingEquipmentCatalog.equipment(s,c)); }
