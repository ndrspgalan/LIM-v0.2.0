...
public final class CourtesanMerchantCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(CourtesanCanonicalProfiles.all(), Profession.COURTESAN, "CourtesanCanonicalProfiles"); check(MerchantCanonicalProfiles.all(), Profession.MERCHANT, "MerchantCanonicalProfiles"); }
