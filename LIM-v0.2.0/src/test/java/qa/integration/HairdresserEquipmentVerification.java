...
public final class HairdresserEquipmentVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(HairdresserCanonicalProfiles.all(), Profession.HAIRDRESSER, (s,c)->HairdresserStartingEquipmentCatalog.equipment(s,c)); }
