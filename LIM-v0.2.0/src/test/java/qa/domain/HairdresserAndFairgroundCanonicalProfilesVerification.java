...
public final class HairdresserAndFairgroundCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(HairdresserCanonicalProfiles.all(), Profession.HAIRDRESSER, "HairdresserCanonicalProfiles"); check(FairgroundWorkerCanonicalProfiles.all(), Profession.FAIRGROUND_WORKER, "FairgroundWorkerCanonicalProfiles"); }
