...
public final class NobleCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(NobleCanonicalProfiles.all(), Profession.NOBLE, "NobleCanonicalProfiles"); }
