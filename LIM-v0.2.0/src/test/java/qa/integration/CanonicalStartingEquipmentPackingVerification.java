...
public final class CanonicalStartingEquipmentPackingVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(DayLaborerCanonicalProfiles.all(), Profession.DAY_LABORER, (s,c)->DayLaborerStartingEquipmentCatalog.equipment(s,c)); audit(HairdresserCanonicalProfiles.all(), Profession.HAIRDRESSER, (s,c)->HairdresserStartingEquipmentCatalog.equipment(s,c)); audit(FairgroundWorkerCanonicalProfiles.all(), Profession.FAIRGROUND_WORKER, (s,c)->FairgroundWorkerStartingEquipmentCatalog.equipment(s,c)); audit(TannerCanonicalProfiles.all(), Profession.TANNER, (s,c)->TannerStartingEquipmentCatalog.equipment(s,c)); audit(DressmakerCanonicalProfiles.all(), Profession.DRESSMAKER, (s,c)->DressmakerStartingEquipmentCatalog.equipment(s,c)); audit(StonemasonCanonicalProfiles.all(), Profession.STONEMASON, (s,c)->StonemasonStartingEquipmentCatalog.equipment(s,c)); }
