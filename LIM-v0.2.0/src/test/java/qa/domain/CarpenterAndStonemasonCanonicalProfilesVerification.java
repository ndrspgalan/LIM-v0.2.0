...
public final class CarpenterAndStonemasonCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(CarpenterCanonicalProfiles.all(), Profession.CARPENTER, "CarpenterCanonicalProfiles"); check(StonemasonCanonicalProfiles.all(), Profession.STONEMASON, "StonemasonCanonicalProfiles"); }
