...
public final class CarpenterHunterSailorStartingEquipmentVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(CarpenterCanonicalProfiles.all(), Profession.CARPENTER, (s,c)->CarpenterStartingEquipmentCatalog.equipment(s,c)); audit(HunterCanonicalProfiles.all(), Profession.HUNTER, (s,c)->HunterStartingEquipmentCatalog.equipment(s,c)); audit(SailorCanonicalProfiles.all(), Profession.SAILOR, (s,c)->SailorStartingEquipmentCatalog.equipment(s,c)); }
