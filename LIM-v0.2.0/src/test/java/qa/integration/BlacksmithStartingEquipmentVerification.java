...
public final class BlacksmithStartingEquipmentVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(BlacksmithCanonicalProfiles.all(), Profession.BLACKSMITH, (s,c)->BlacksmithStartingEquipmentCatalog.equipment(s,c)); }
