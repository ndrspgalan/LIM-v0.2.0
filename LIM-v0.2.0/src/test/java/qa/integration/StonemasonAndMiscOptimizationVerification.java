...
public final class StonemasonAndMiscOptimizationVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(StonemasonCanonicalProfiles.all(), Profession.STONEMASON, (s,c)->StonemasonStartingEquipmentCatalog.equipment(s,c)); }
