...
public final class BlacksmithAndSoldierCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(BlacksmithCanonicalProfiles.all(), Profession.BLACKSMITH, "BlacksmithCanonicalProfiles"); check(SoldierCanonicalProfiles.all(), Profession.SOLDIER, "SoldierCanonicalProfiles"); }
