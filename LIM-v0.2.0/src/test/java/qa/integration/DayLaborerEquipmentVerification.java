...
public final class DayLaborerEquipmentVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(DayLaborerCanonicalProfiles.all(), Profession.DAY_LABORER, (s,c)->DayLaborerStartingEquipmentCatalog.equipment(s,c)); }
