...
public final class PatrimonialLogisticsAndFairgroundVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("integration")
        void verifiesCanonicalContract(){ audit(BeggarCanonicalProfiles.all(), Profession.BEGGAR, (s,c)->BeggarStartingEquipmentCatalog.equipment(s,c)); audit(FairgroundWorkerCanonicalProfiles.all(), Profession.FAIRGROUND_WORKER, (s,c)->FairgroundWorkerStartingEquipmentCatalog.equipment(s,c)); }
