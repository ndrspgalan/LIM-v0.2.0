...
public final class DayLaborerCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(DayLaborerCanonicalProfiles.all(), Profession.DAY_LABORER, "DayLaborerCanonicalProfiles"); }
