...
public final class TannerAndDressmakerCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(TannerCanonicalProfiles.all(), Profession.TANNER, "TannerCanonicalProfiles"); check(DressmakerCanonicalProfiles.all(), Profession.DRESSMAKER, "DressmakerCanonicalProfiles"); }
