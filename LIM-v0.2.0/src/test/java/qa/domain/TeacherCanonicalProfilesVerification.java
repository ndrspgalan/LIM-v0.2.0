...
public final class TeacherCanonicalProfilesVerification {
 @org.junit.jupiter.api.Test
    @org.junit.jupiter.api.Tag("domain")
        void verifiesCanonicalContract(){ check(TeacherCanonicalProfiles.all(), Profession.TEACHER, "TeacherCanonicalProfiles"); }
